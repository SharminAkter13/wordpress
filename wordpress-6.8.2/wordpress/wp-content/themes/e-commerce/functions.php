...
{
	wp_enqueue_style('e-commerce-style', get_stylesheet_uri(), array(), '2.0');

	wp_enqueue_style('e-commerce-fonts', e_commerce_fonts_url(), array(), '2.0');

	// Font Awesome
	wp_enqueue_style('fontawesome', trailingslashit(esc_url(get_template_directory_uri())) . 'css/font-awesome/css/all.min.css', array(), '6.7.2', 'all');

	wp_enqueue_script('e-commerce-navigation', trailingslashit(esc_url(get_template_directory_uri())) . 'js/navigation.js', array(), '2.0', true);

	wp_enqueue_script('e-commerce-helpers', trailingslashit(esc_url(get_template_directory_uri())) . 'js/helpers.js', array('jquery'), '2.0', true);

	wp_enqueue_script('e-commerce-skip-link-focus-fix', trailingslashit(esc_url(get_template_directory_uri())) . 'js/skip-link-focus-fix.js', array(), '2.0', true);
...
{
	wp_enqueue_style('e-commerce-font', e_commerce_fonts_url(), array(), '2.0');
}
