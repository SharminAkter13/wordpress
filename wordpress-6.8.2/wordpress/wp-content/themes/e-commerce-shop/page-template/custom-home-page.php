	...
	<div class="container">
		<div class="row">
			<div class="col-lg-9 col-md-9">
				...
				<?php if( get_theme_mod('bb_ecommerce_store_slider_hide_show', true) != '' || get_theme_mod('bb_ecommerce_store_responsive_slider', true) != '' ){ ?>
			...
			<div class="col-lg-3 col-md-3 static-sidebar mb-3 p-0">
