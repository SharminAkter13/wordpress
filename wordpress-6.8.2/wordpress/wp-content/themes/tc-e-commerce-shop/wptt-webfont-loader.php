...
if ( ! class_exists( 'Tc_E_Commerce_Shop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Tc_E_Commerce_Shop_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'tc_e_commerce_shop_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function tc_e_commerce_shop_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Tc_E_Commerce_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'tc_e_commerce_shop_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function tc_e_commerce_shop_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Tc_E_Commerce_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
