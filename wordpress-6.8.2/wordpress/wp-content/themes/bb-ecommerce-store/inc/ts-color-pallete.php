<?php
	...
	#sidebar h3, #sidebar .widget_block h2, #sidebar .widget_block.widget_search label, #scroll-top{';
	...
	$bb_ecommerce_store_custom_css .='.primary-navigation ul ul,.copyright-wrapper form.woocommerce-product-search button, #sidebar form.woocommerce-product-search button, #scroll-top{';
	...
	// css
	$bb_ecommerce_store_show_header = get_theme_mod( 'bb_ecommerce_store_slider_hide_show', true);
	...
	if($bb_ecommerce_store_slider == true && get_theme_mod( 'bb_ecommerce_store_slider_hide_show', true) == false){
	...
	$bb_ecommerce_store_align_footer_social_icon = get_theme_mod('bb_ecommerce_store_align_footer_social_icon');
	if($bb_ecommerce_store_align_footer_social_icon != false){
		$bb_ecommerce_store_custom_css .='.footer-social-icon{';
			$bb_ecommerce_store_custom_css .='text-align: '.esc_attr($bb_ecommerce_store_align_footer_social_icon).';';
		$bb_ecommerce_store_custom_css .='}';
		$bb_ecommerce_store_custom_css .='
	...
	// Footer Icon Font Size
	$bb_ecommerce_store_footer_icon_font_size = get_theme_mod('bb_ecommerce_store_footer_icon_font_size');
	$bb_ecommerce_store_custom_css .='.footer-social-icon i{';
		$bb_ecommerce_store_custom_css .='font-size: '.esc_attr($bb_ecommerce_store_footer_icon_font_size).'px;';
	$bb_ecommerce_store_custom_css .='}';
	...
	$bb_ecommerce_store_custom_css .='#our-services .new-text .read-btn a, #our-services .grid-box .read-more-btn a{';
	...
	// Display Grid Post 
	$bb_ecommerce_store_display_grid_page_post = get_theme_mod( 'bb_ecommerce_store_display_grid_page_post','In Box');
	if($bb_ecommerce_store_display_grid_page_post == 'In Box'){
		$bb_ecommerce_store_custom_css .='.inner-service.grid-box{';
			$bb_ecommerce_store_custom_css .='background: #f6f6f6;';
		$bb_ecommerce_store_custom_css .='}';
	}else if($bb_ecommerce_store_display_grid_page_post == 'Without Box'){
		$bb_ecommerce_store_custom_css .='.inner-service.grid-box{';
			$bb_ecommerce_store_custom_css .='border:none; margin:25px 0; ';
		$bb_ecommerce_store_custom_css .='}';
	}
	...
	// Blog Post ALignment
	$bb_ecommerce_store_blog_post_alignment = get_theme_mod( 'bb_ecommerce_store_blog_post_alignment','Left');
    if($bb_ecommerce_store_blog_post_alignment == 'Left'){
		$bb_ecommerce_store_custom_css .='.services .ecomercepost-title, .services .metabox, .services .new-text, .inner-service .post-categories{';
		$bb_ecommerce_store_custom_css .='text-align: left;';
		$bb_ecommerce_store_custom_css .='}';
	}else if($bb_ecommerce_store_blog_post_alignment == 'Center'){
		$bb_ecommerce_store_custom_css .='.services .ecomercepost-title, .services .metabox, .services .new-text, .inner-service .post-categories{';
			$bb_ecommerce_store_custom_css .='text-align: center;';
		$bb_ecommerce_store_custom_css .='}';
	}else if($bb_ecommerce_store_blog_post_alignment == 'Right'){
		$bb_ecommerce_store_custom_css .='.services .ecomercepost-title, .services .metabox, .services .new-text, .inner-service .post-categories{';
			$bb_ecommerce_store_custom_css .='text-align: right;';
		$bb_ecommerce_store_custom_css .='}';
	}
	...
	$bb_ecommerce_store_pagination_alignment = get_theme_mod( 'bb_ecommerce_store_pagination_alignment','Left');
    if($bb_ecommerce_store_pagination_alignment == 'Left'){
		$bb_ecommerce_store_custom_css .='.pagination, .nav-links{';
		$bb_ecommerce_store_custom_css .='float: left;';
		$bb_ecommerce_store_custom_css .='}';
	}else if($bb_ecommerce_store_pagination_alignment == 'Center'){
		$bb_ecommerce_store_custom_css .='.pagination, .nav-links{';
			$bb_ecommerce_store_custom_css .='justify-content: center; float: none;';
		$bb_ecommerce_store_custom_css .='}';
	}else if($bb_ecommerce_store_pagination_alignment == 'Right'){
		$bb_ecommerce_store_custom_css .='.pagination, .nav-links{';
			$bb_ecommerce_store_custom_css .='float: right;';
		$bb_ecommerce_store_custom_css .='}';
	}
	...
	// Grid post featured image setting
	$bb_ecommerce_store_img_border_radius_grid_post = get_theme_mod('bb_ecommerce_store_img_border_radius_grid_post', 0);
	$bb_ecommerce_store_custom_css .='#our-services .grid-box .box-image img{';
		$bb_ecommerce_store_custom_css .='border-radius: '.esc_attr($bb_ecommerce_store_img_border_radius_grid_post).'px;';
	$bb_ecommerce_store_custom_css .='}';
	...
	// Menu hover effect
	$bb_ecommerce_store_menus_item = get_theme_mod( 'bb_ecommerce_store_menus_item_style','None');
    if($bb_ecommerce_store_menus_item == 'None'){
		$bb_ecommerce_store_custom_css .='.primary-navigation ul a{';
			$bb_ecommerce_store_custom_css .='';
		$bb_ecommerce_store_custom_css .='}';
	}else if($bb_ecommerce_store_menus_item == 'Zoom In'){
		$bb_ecommerce_store_custom_css .='.primary-navigation ul a:hover{';
			$bb_ecommerce_store_custom_css .='transition: all 0.3s ease-in-out !important; transform: scale(1.2) !important;';
		$bb_ecommerce_store_custom_css .='}';
	}
