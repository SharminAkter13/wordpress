...
function bb_ecommerce_store_customize_register( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial( 'blogname', array(
		'selector' => '.logo .site-title a',
	 	'render_callback' => 'bb_ecommerce_store_customize_partial_blogname',
	));

	$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
		'selector' => 'p.site-description',
		'render_callback' => 'bb_ecommerce_store_customize_partial_blogdescription',
	));
	...
	$wp_customize->add_setting('bb_ecommerce_store_typography_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_typography_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_theme_color_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_theme_color_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_topbar_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_topbar_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_menus_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_menus_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_menus_item_style',array(
		'default' => '',
		'transport' => 'refresh',
		'sanitize_callback' => 'bb_ecommerce_store_sanitize_choices'
	));
	$wp_customize->add_control('bb_ecommerce_store_menus_item_style',array(
		'type' => 'select',
		'section' => 'bb_ecommerce_store_menus_settings',
		'label' => __('Menu Hover Effect','bb-ecommerce-store'),
		'choices' => array(
			'None' => __('None','bb-ecommerce-store'),
			'Zoom In' => __('Zoom In','bb-ecommerce-store'),
		),
	) );
	...
	$wp_customize->add_setting('bb_ecommerce_store_social_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_social_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_control('bb_ecommerce_store_slider_premium_info',array(
		...
		'description' => "<ul><li>". esc_html__('You can change how many slides there are.','bb-ecommerce-store') ."</li><li>". esc_html__('You can change the font family and the colours of headings and subheadings.','bb-ecommerce-store') ."</li><li>". esc_html__('And so on...','bb-ecommerce-store') ."</li></ul><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_control('bb_ecommerce_store_services_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','bb-ecommerce-store'),
		'description' => "<ul><li>". esc_html__('For more settings and features, please explore our premium theme.','bb-ecommerce-store') ."</li></ul><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_control('bb_ecommerce_store_product_sec_premium_info',array(
		'type'=> 'hidden',
		'label'	=> __('Premium Features','bb-ecommerce-store'),
		'description' => "<ul><li>". esc_html__('Includes settings to set section title.','bb-ecommerce-store') ."</li><li>". esc_html__('Contains settings for the background colour.','bb-ecommerce-store') ."</li><li>". esc_html__('Contains options for background images.','bb-ecommerce-store') ."</li><li>". esc_html__('You can change the font family and colours of heading.','bb-ecommerce-store') ."</li><li>". esc_html__('And so on...','bb-ecommerce-store') ."</li></ul><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_blog_post_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_blog_post_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
		'section'=> 'bb_ecommerce_store_blog_post'
	));

	$wp_customize->selective_refresh->add_partial( 'bb_ecommerce_store_date_hide', array(
		'selector' => 'article.inner-service',
		'render_callback' => 'bb_ecommerce_store_customize_partial_bb_ecommerce_store_date_hide',
	));
	...
	$wp_customize->add_setting('bb_ecommerce_store_show_post_category',array(
       'default' => true,
       'sanitize_callback'	=> 'bb_ecommerce_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('bb_ecommerce_store_show_post_category',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Category','bb-ecommerce-store'),
       'section' => 'bb_ecommerce_store_blog_post'
    ));
	...
	$wp_customize->add_setting('bb_ecommerce_store_blog_post_alignment',array(
	    'default' => 'Left',
	    'transport' => 'refresh',
	    'sanitize_callback' => 'bb_ecommerce_store_sanitize_choices'
	));
	$wp_customize->add_control('bb_ecommerce_store_blog_post_alignment',array(
	    'type' => 'select',
	    'label' => __('Blog Post Alignment','bb-ecommerce-store'),
	    'section' => 'bb_ecommerce_store_blog_post',
	    'choices' => array(
	    	'Left' => __('Left','bb-ecommerce-store'),
	        'Center' => __('Center','bb-ecommerce-store'),
	...
	$wp_customize->add_setting('bb_ecommerce_store_pagination_alignment',array(
	    'default' => 'Left',
	    'transport' => 'refresh',
	    'sanitize_callback' => 'bb_ecommerce_store_sanitize_choices'
	));
	$wp_customize->add_control('bb_ecommerce_store_pagination_alignment',array(
	    'type' => 'select',
	    'label' => __('Pagination Alignment','bb-ecommerce-store'),
	    'section' => 'bb_ecommerce_store_blog_post',
	    'choices' => array(
	    	'Left' => __('Left','bb-ecommerce-store'),
	        'Center' => __('Center','bb-ecommerce-store'),
	...
	$wp_customize->add_setting('bb_ecommerce_store_theme_button_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_theme_button_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
		'section'=> 'bb_ecommerce_store_theme_button'
	));

	$wp_customize->selective_refresh->add_partial( 'bb_ecommerce_store_button_text', array(
		'selector' => '#our-services .new-text .read-btn a',
		'render_callback' => 'bb_ecommerce_store_customize_partial_bb_ecommerce_store_button_text',
	));
	...
	$wp_customize->add_setting('bb_ecommerce_store_single_post_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_single_post_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
		'section'=> 'bb_ecommerce_store_single_post'
	));

	$wp_customize->selective_refresh->add_partial( 'bb_ecommerce_store_single_post_date_hide', array(
		'selector' => '.single-post .page-box-single',
		'render_callback' => 'bb_ecommerce_store_customize_partial_bb_ecommerce_store_single_post_date_hide',
	));
	...
	$wp_customize->add_setting('bb_ecommerce_store_grid_post_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_grid_post_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_grid_post_date_icon',array(
		'default'	=> 'fa fa-calendar',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new BB_Ecommerce_Store_Icon_Changer(
        $wp_customize,'bb_ecommerce_store_grid_post_date_icon',array(
		'label'	=> __('Date Icon','bb-ecommerce-store'),
		'transport' => 'refresh',
		'section'	=> 'bb_ecommerce_store_grid_post',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('bb_ecommerce_store_grid_post_author_icon',array(
		'default'	=> 'fas fa-user',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new BB_Ecommerce_Store_Icon_Changer(
        $wp_customize,'bb_ecommerce_store_grid_post_author_icon',array(
		'label'	=> __('Author Icon','bb-ecommerce-store'),
		'transport' => 'refresh',
		'section'	=> 'bb_ecommerce_store_grid_post',
		'type'		=> 'icon'
	...
	$wp_customize->add_setting('bb_ecommerce_store_grid_post_comment_icon',array(
		'default'	=> 'fas fa-comments',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new BB_Ecommerce_Store_Icon_Changer(
        $wp_customize,'bb_ecommerce_store_grid_post_comment_icon',array(
		'label'	=> __('Comment Icon','bb-ecommerce-store'),
		'transport' => 'refresh',
		'section'	=> 'bb_ecommerce_store_grid_post',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('bb_ecommerce_store_grid_post_time_icon',array(
		'default'	=> 'fas fa-clock',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new BB_Ecommerce_Store_Icon_Changer(
        $wp_customize,'bb_ecommerce_store_grid_post_time_icon',array(
		'label'	=> __('Time Icon','bb-ecommerce-store'),
		'transport' => 'refresh',
		'section'	=> 'bb_ecommerce_store_grid_post',
		'type'		=> 'icon'
    ...
    $wp_customize->add_setting( 'bb_ecommerce_store_grid_excerpt_number', array(
		'default'              => 20,
		'sanitize_callback'	=> 'absint',
	) );
	$wp_customize->add_control( 'bb_ecommerce_store_grid_excerpt_number', array(
		'label'       => esc_html__( 'Excerpt length','bb-ecommerce-store' ),
		'section'     => 'bb_ecommerce_store_grid_post',
		'type'        => 'number',
		'settings'    => 'bb_ecommerce_store_grid_excerpt_number',
		'input_attrs' => array(
			'step'             => 2,
			'min'              => 0,
			'max'              => 50,
	...
	$wp_customize->add_setting( 'bb_ecommerce_store_metabox_separator_grid_post', array(
		'default'   => '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'bb_ecommerce_store_metabox_separator_grid_post', array(
		'label'       => esc_html__( 'Meta Box Separator','bb-ecommerce-store' ),
		'input_attrs' => array(
            'placeholder' => __( 'Add Meta Separator. e.g.: "|", "/", etc.', 'bb-ecommerce-store' ),
        ),
		'section'     => 'bb_ecommerce_store_grid_post',
		'type'        => 'text',
		'settings'    => 'bb_ecommerce_store_metabox_separator_grid_post',
	) );

    $wp_customize->add_setting('bb_ecommerce_store_show_image_grid_post',array(
       'default' => true,
       'sanitize_callback'	=> 'bb_ecommerce_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('bb_ecommerce_store_show_image_grid_post',array(
       'type' => 'checkbox',
       'label' => __('Grid Post Image','bb-ecommerce-store'),
       'section' => 'bb_ecommerce_store_grid_post'
    ));

    $wp_customize->add_setting( 'bb_ecommerce_store_img_border_radius_grid_post', array(
		'default'=> 0,
		'sanitize_callback'	=> 'bb_ecommerce_store_sanitize_float',
	) );
	$wp_customize->add_control( 'bb_ecommerce_store_img_border_radius_grid_post', array(
		'label'       => esc_html__( 'Grid Post Image Border Radius','bb-ecommerce-store' ),
		'section'     => 'bb_ecommerce_store_grid_post',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting('bb_ecommerce_store_display_grid_page_post',array(
        'default' => 'In Box',
        'sanitize_callback' => 'bb_ecommerce_store_sanitize_choices'
	));
	$wp_customize->add_control('bb_ecommerce_store_display_grid_page_post',array(
        'type' => 'radio',
        'label' => __('Display Grid Post Box :','bb-ecommerce-store'),
        'section' => 'bb_ecommerce_store_grid_post',
        'choices' => array(
            'In Box' => __('In Box','bb-ecommerce-store'),
            'Without Box' => __('Without Box','bb-ecommerce-store'),
	...
	$wp_customize->add_setting('bb_ecommerce_store_related_post_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_related_post_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
		'section'=> 'bb_ecommerce_store_related_post'
	));

	$wp_customize->selective_refresh->add_partial( 'bb_ecommerce_store_show_related_post', array(
		'selector' => '.related-posts',
		'render_callback' => 'bb_ecommerce_store_customize_partial_bb_ecommerce_store_show_related_post',
	));
    ...
    $wp_customize->add_setting('bb_ecommerce_store_show_featured_image_related_post',array(
       'default' => true,
       'sanitize_callback'	=> 'bb_ecommerce_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('bb_ecommerce_store_show_featured_image_related_post',array(
       'type' => 'checkbox',
       'label' => __('Related Post Image','bb-ecommerce-store'),
       'section' => 'bb_ecommerce_store_related_post'
    ));
	...
	$wp_customize->add_setting('bb_ecommerce_store_related_post_date_hide',array(
       'default' => true,
       'sanitize_callback'	=> 'bb_ecommerce_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('bb_ecommerce_store_related_post_date_hide',array(
       'type' => 'checkbox',
       'label' => __('Post Date','bb-ecommerce-store'),
       'section' => 'bb_ecommerce_store_related_post'
    ));

	$wp_customize->add_setting('bb_ecommerce_store_related_post_date_icon',array(
		'default'	=> 'fa fa-calendar',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new BB_Ecommerce_Store_Icon_Changer(
        $wp_customize,'bb_ecommerce_store_related_post_date_icon',array(
		'label'	=> __('Post Date Icon','bb-ecommerce-store'),
		'transport' => 'refresh',
		'section'	=> 'bb_ecommerce_store_related_post',
		'type'		=> 'icon'
	...
	$wp_customize->add_setting('bb_ecommerce_store_left_right_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_left_right_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_noresult_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_noresult_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_404_page_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_404_page_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_responsive_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_responsive_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
	...
	$wp_customize->add_setting('bb_ecommerce_store_footer_premium_info',array(
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('bb_ecommerce_store_footer_premium_info',array(
		'type'=> 'hidden',
		'description' => "<p>". esc_html__('Upgrade to premium for more features.','bb-ecommerce-store') ."</p><a target='_blank' href='". esc_url(BB_ECOMMERCE_STORE_BUY_NOW) ." '>". esc_html__('Upgrade to Pro','bb-ecommerce-store') ."</a>",
		'section'=> 'bb_ecommerce_store_footer_section'
	));

	$wp_customize->selective_refresh->add_partial( 'bb_ecommerce_store_show_hide_footer', array(
		'selector' => '#footer',
		'render_callback' => 'bb_ecommerce_store_customize_partial_bb_ecommerce_store_show_hide_footer',
	));
	...
	$wp_customize->selective_refresh->add_partial('bb_ecommerce_store_show_hide_copyright', array(
		'selector' => '.copyright p',
		'render_callback' => 'bb_ecommerce_store_customize_partial_bb_ecommerce_store_show_hide_copyright',
	));
	...
	$wp_customize->selective_refresh->add_partial( 'bb_ecommerce_store_enable_disable_scroll', array(
		'selector' => '#scroll-top i',
		'render_callback' => 'bb_ecommerce_store_customize_partial_bb_ecommerce_store_enable_disable_scroll',
	));
	...
	//Footer Social Icon
	$wp_customize->add_section( 'bb_ecommerce_store_footer_social_icon' , array(
    	'title'      => __( 'Footer Social Icon Settings', 'bb-ecommerce-store' ),
		'panel' => 'bb_ecommerce_store_panel_id'
	) );

	$wp_customize->add_setting('bb_ecommerce_store_show_hide_footer_social_icon',array(
		'default' => false,
		'sanitize_callback'	=> 'bb_ecommerce_store_sanitize_checkbox'
	));
	$wp_customize->add_control('bb_ecommerce_store_show_hide_footer_social_icon',array(
     	'type' => 'checkbox',
      	'label' => __('Show / Hide Footer Social Icon','bb-ecommerce-store'),
      	'section' => 'bb_ecommerce_store_footer_social_icon',
	));

	for ( $bb_ecommerce_store_j = 1; $bb_ecommerce_store_j <= 5; $bb_ecommerce_store_j++ ) {
		$wp_customize->add_setting('bb_ecommerce_store_social_icon_url' .$bb_ecommerce_store_j,array(
			'default'	=> '',
			'sanitize_callback'	=> 'esc_url_raw'
		));	
		$wp_customize->add_control('bb_ecommerce_store_social_icon_url' .$bb_ecommerce_store_j,array(
			'label'	=> __('Add Social link','bb-ecommerce-store'),
			'section'	=> 'bb_ecommerce_store_footer_social_icon',
			'setting'	=> 'bb_ecommerce_store_social_icon_url' .$bb_ecommerce_store_j,
			'type'	=> 'url'
		));

		$wp_customize->add_setting('bb_ecommerce_store_select_social_icon' .$bb_ecommerce_store_j,array(
			'default'	=> '',
			'sanitize_callback'	=> 'sanitize_text_field'
		));
		$wp_customize->add_control(new BB_Ecommerce_Store_Icon_Changer(
	        $wp_customize,'bb_ecommerce_store_select_social_icon' .$bb_ecommerce_store_j,array(
			'label'	=> __('Add Social Icon','bb-ecommerce-store'),
			'transport' => 'refresh',
			'section'	=> 'bb_ecommerce_store_footer_social_icon',
			'type'		=> 'icon'
		)));
	...
	$wp_customize->add_setting('bb_ecommerce_store_align_footer_social_icon',array(
        'default' => 'center',
        'sanitize_callback' => 'bb_ecommerce_store_sanitize_choices'
	));
	$wp_customize->add_control('bb_ecommerce_store_align_footer_social_icon',array(
        'type' => 'select',
        'label' => __('Social Icon Alignment ','bb-ecommerce-store'),
        'section' => 'bb_ecommerce_store_footer_social_icon',
        'choices' => array(
            'left' => __('Left','bb-ecommerce-store'),
            'right' => __('Right','bb-ecommerce-store'),
	...
	$wp_customize->add_setting('bb_ecommerce_store_footer_icon_font_size',array(
		'default'=> '',
		'sanitize_callback'	=> 'bb_ecommerce_store_sanitize_float'
	));
	$wp_customize->add_control('bb_ecommerce_store_footer_icon_font_size',array(
		'label'	=> __('Footer Icon Font Size','bb-ecommerce-store'),
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
			'max'              => 50,
