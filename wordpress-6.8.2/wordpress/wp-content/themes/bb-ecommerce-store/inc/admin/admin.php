...
<div class="wrapper-info">
	 <div class="header">
		...
		<div class="main-button">
			...
			<a href="<?php echo esc_url( BB_ECOMMERCE_STORE_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'bb-ecommerce-store'); ?></a>
			<a href="<?php echo esc_url( BB_ECOMMERCE_STORE_PRO_DOC ); ?>" target="_blank"><?php esc_html_e('Pro Documentation', 'bb-ecommerce-store'); ?></a>
		</div>
	</div>
	<div class="button-bg">
		<button role="tab" class="tablink" onclick="openPage('Demo', this, '')"><?php esc_html_e('Demo Import', 'bb-ecommerce-store'); ?></button>
	...
	<div id="Demo" class="tabcontent tab1">
		<div class="demo-info">
			<h3><?php esc_html_e( 'To import demo content, click the "Run Importer" button below.', 'bb-ecommerce-store' ); ?></h3>
			<?php 
			/* Get Started. */ 
	...
	<div id="Home" class="tabcontent">
	  	...
	  	<div class="sec-button">
			...
			<a href="<?php echo esc_url( BB_ECOMMERCE_STORE_CONTACT ); ?>" target="_blank"><?php esc_html_e('Support', 'bb-ecommerce-store'); ?></a>
