...
$related_posts = bb_ecommerce_store_related_posts();
            ...
            <?php while ( $related_posts->have_posts() ) : $related_posts->the_post(); ?>
                <div class="col-lg-4 col-md-6">
                    <div class="related-box mb-3 p-3">
                        <?php if( get_theme_mod( 'bb_ecommerce_store_related_post_date_hide',true) != '') { ?>
                            <div class="metabox">
                                <span class="entry-date me-1"><i class="<?php echo esc_attr(get_theme_mod('bb_ecommerce_store_related_post_date_icon','fa fa-calendar')); ?>"></i><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span>
                            </div>
                        <?php } ?>
                        <?php if( get_theme_mod( 'bb_ecommerce_store_show_featured_image_related_post',true) != '') { ?>
