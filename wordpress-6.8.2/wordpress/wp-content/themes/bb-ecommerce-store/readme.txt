...
= 1.7 =
  * Added show/hide slider title settings.
  * Updated POT file.
...
= 1.8.5 =
  ...
  * Added Search responsive setting for mobile.
  * Updated POT file.
...
= 1.9.2 =
  * Added css for header section row.
...
= 1.9.5 =
  * Added comment form heading text option in single post settings.
  * Added comment form button text option in single post settings.
  * Added single post meta box seperator option.
  * Updated .pot file. 

= 1.9.6 =
  * Added single post date, author, comment and time option.
  * Added menu text transform and menus font size options in topbar section.
  * Added related post content limit option in single post settings.
  * Updated pot. file.

= 1.9.7 =
  * Added menus settings section in theme settings.
  * Change menu font weight text in menus settings.
  * Added menu padding option in menu settings.
  * Updated pot. file.  
...
= 2.0 = 
  * Added breadcrumb color option in layout settings.
  * Added breadcrumb background color option in layout settings.
  ...
  * Added menu button alignment option in responsive settings.
...
= 2.0.2 =   
  ...
  * Resolved error for theme color option. 
  * Updated .pot file. 
...
= 2.0.6 =      
  ...
  * Resolved error for pagination in block layout.
...
= 2.1 =      
  ...
  * Added youtube, facebook, twitter, instagram and RSS icons options in social icon section.
  * Updated .pot file.
...
= 2.2.1 =      
  * Added button font weight option in blog post settings.
  * Added first cap (first capital letter) option in blog post settings.
  * Updated .pot file.

= 2.2.2 =   
  * Added upgrade to pro button in slider settings and products section.   
...
= 2.2.4 =   
  * Added phone icon and email icon options in topbar section.
...
= 2.2.5 =   
  ...
  * Updated .pot file.
  * Resolved css error for scroll back to top icon in footer text section.
  * Tested upto WP v6.5
...
= 2.2.6 =   
  ...
  * Resolved css error for menu icons.
...
= 2.3.3 =   
  ...
  * Added pagination alignment option in blog post settings.

= 2.3.4 =   
  * Added blog post alignment option in blog post settings.
...
= 2.3.7 =   
  * Added upgrade to pro button in all sections.
  * Resolved css error for button in checkout page.
  * Added show / hide post date and post date icon options in related post settings.
  * Updated .pot file.

= 2.3.8 =   
  * Added footer social icon settings section.
  * Added social link and social icon options in footer social icon settings.
  * Added show / hide footer social icon option in footer social icon settings.
  * Added social icon alignment option in footer social icon settings. 
  * Updated .pot file.

= 2.3.9 =   
  * Added grid post image option in grid post settings.
  * Added grid post image border radius option in grid post settings.
  * Added display grid post box option in grid post settings.
  * Resolved error for button font size.
  * Updated .pot file.
  * Tested upto WP v6.8

= 2.4 =   
  * Added footer icon font size option in footer social icon settings.
  * Resolved theme notice warning.
  * Updated activation notice.
  * Added category in blog post.
  * Added show / hide category option in blog post settings.
  * Resolved css error for new products.

= 2.4.1 =   
  * Added css for scroll to top.
  * Resolved blog post alignment option in blog post settings.
  * Added edit links for customizer options.
  * Added classes for global color.
...
8. Screenshot Images.
  ...
  Slider image
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://stocksnap.io/photo/HNG621YITW
