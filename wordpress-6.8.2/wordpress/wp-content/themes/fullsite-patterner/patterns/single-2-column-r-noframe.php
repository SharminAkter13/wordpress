...
/**
 *
 * Title: Single-2column-R-noframe
 * Slug: fullsite-patterner/single-2column-r-noframe
...
<div id="Single-2-R-noframe" class="wp-block-group"><!-- wp:template-part {"slug":"header-navbar","theme":"fullsite-patterner","area":"header"} /-->
...
<!-- wp:template-part {"slug":"single-article-2-column","theme":"fullsite-patterner"} /--></div>
<!-- /wp:group -->
