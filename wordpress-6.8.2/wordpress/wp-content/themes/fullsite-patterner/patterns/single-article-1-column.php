<?php
/**
 * Title: single-article-1-column
 * Slug: fullsite-patterner/single-article-1-column
...
<section id="section" class="wp-block-group has-my-light-blue-background-color has-background" style="border-radius:8px"><!-- wp:post-featured-image /-->
