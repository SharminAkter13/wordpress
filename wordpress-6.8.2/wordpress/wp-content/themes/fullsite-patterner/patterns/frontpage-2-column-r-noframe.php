...
/**
 *
 * Title: FrontPage-2column-R-noframe
 * Slug: fullsite-patterner/frontpage-2column-r-noframe
...
<div id="Front-2-R-noframe" class="wp-block-group"><!-- wp:template-part {"slug":"header-navbar","theme":"fullsite-patterner","area":"header"} /-->
...
<!-- /wp:spacer -->
<!-- wp:group {"lock":{"move":true,"remove":true},"className":"fsp-noframe row","layout":{"type":"default"}} -->
...
<!-- wp:template-part {"slug":"frontpage-article-2-column","theme":"fullsite-patterner"} /--></div>
<!-- /wp:group -->
