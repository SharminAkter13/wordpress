...
/**
 *
 * Title: Search-2column-R-noframe
 * Slug: fullsite-patterner/search-2column-r-noframe
...
<div id="Search-2-R-noframe" class="wp-block-group"><!-- wp:template-part {"slug":"header-navbar","theme":"fullsite-patterner","area":"header"} /-->
...
<!-- wp:template-part {"slug":"search-article-2-column","theme":"fullsite-patterner"} /--></div>
<!-- /wp:group -->
