...
/**
 *
 * Title: Footer-2column-copyright
 * Slug: fullsite-patterner/footer-2-column-copyright
...
<div id="footer-2column-fsp" class="wp-block-group fsp-footer container-fluid"><!-- wp:group {"lock":{"move":true,"remove":true},"className":"row","layout":{"type":"default"}} -->
...
<!-- wp:group {"lock":{"move":true,"remove":true},"className":"col-sm-12 col-md-6 col-lg-6","layout":{"type":"default"}} -->
<div id="footer-left-fsp" class="wp-block-group col-sm-12 col-md-6 col-lg-6"><!-- wp:heading {"textAlign":"left","level":3,"textColor":"black"} -->
...
<!-- wp:group {"lock":{"move":true,"remove":true},"className":"col-sm-12 col-md-6 col-lg-6","layout":{"type":"default"}} -->
<div id="footer-right-fsp" class="wp-block-group col-sm-12 col-md-6 col-lg-6"><!-- wp:heading {"textAlign":"left","level":3,"textColor":"black"} -->
