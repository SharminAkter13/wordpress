...
class ThemePageController
{
    ...
    public static function ThemePageSubMenu()
    {
        ...
        add_submenu_page('themes.php', __('Theme Settings', 'woodix-e-commerce'), __('Theme Settings', 'woodix-e-commerce') . $awaiting, 'manage_options', self::GetPageSlug(), array(__CLASS__, 'ThemePageContent'), 1);
    }
    ...
    public static function EnqueueScripts($hook)
    {
        ...
        wp_enqueue_style(self::GetPageSlug(), get_stylesheet_directory_uri() . '/inc/superbthemes-info-content/theme-page/themepage.css');
    }
